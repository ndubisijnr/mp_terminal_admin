...
function init() {
  ...
  StoreUtils.getter()?.terminal?.getOrganizationTerminal(organisations.value?.organisationId ?? "")
}
...
<template>
    ...
    <MazDialogPromise identifier="two" :buttons="buttons">
      ...
      <div class="overflow-auto rounded-lg shadow">
        ...
        <DataTable v-model:filters="filters" :value="terminalOrganizations" :metaKeySelection="metaKey" selectionMode="single" paginator :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]" stripedRows tableStyle="min-width: 50rem"
